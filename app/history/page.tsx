...
import { ArrowLeft, CalendarDays, Check, Clock3, UserX } from "lucide-react";
...
export default function HistoryPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-6 text-slate-950 sm:px-6 lg:px-10"><div className="mx-auto max-w-6xl space-y-6">
      ...
      </div><div className="flex items-center gap-2 rounded-full bg-slate-100 px-4 py-2 text-sm font-semibold text-slate-600"><CalendarDays className="size-4" /> {history.length} {history.length === 1 ? "day" : "days"} saved</div></header>
